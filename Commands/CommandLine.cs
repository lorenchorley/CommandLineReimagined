...
namespace CommandLineReimagine.Commands
{
    public class CommandLine
    {
        ...
        public CommandLine(IServiceProvider serviceProvider, EntityComponentSystem ecs, IEnumerable<CommandAction> commandActions, ConsoleLayout consoleRenderer, CommandHistoryModule commandHistoryModule, ConsoleOutModule consoleOutModule)
        {
