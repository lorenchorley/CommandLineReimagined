...
/// </summary>
/// <remarks>
/// Text. It used to turn directory entries into buttons carrying a path, a context
/// menu and a double-click action; those were built on path values, and the filesystem
/// is attribute records now. Decision 0012 keeps the desktop shell out of scope, so the
/// requirement is that it compiles and runs commands; an interactive listing would be
/// new work for the owner to ask for.
///
