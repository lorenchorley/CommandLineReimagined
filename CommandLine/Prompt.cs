    ...
    private void RefreshText()
    {
        ...
        result.Switch(
            tree =>
            {
                ...
                var visitor = new UITokenisationVisitor(_scene.Input.PromptLines);
                tree.Accept(visitor);
                ...
                _scene.Input.IsCommandExecutable = true;
            },
            parserError =>
            {
                _scene.Input.IsCommandExecutable = false;
