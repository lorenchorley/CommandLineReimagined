...
| [Execution model](execution-model.md) | Values, argument binding, pipelines, tags, undo, cancellation. |
...
| Conformance suite | `Parser.Tests` (375), `Core.Tests` (823), `Web.Core.Tests` (142), `Terminal.Tests` (32) |
