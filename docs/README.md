...
A [proposed design direction](plan/scene-editor-direction.md) records where the
original entity component system's idea could go next: a scene the command line builds
and edits, rendered on a canvas beside the terminal.
